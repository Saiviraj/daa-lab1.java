import java.lang.*; import java.util.*; import java.io.*; class Main {
...
if (setOfMST[vertex] == false && keys[vertex] < minimum_value) { minimum_value = keys[vertex];
...
for (int j = 0; j < countOfVertices; j++) { keys[j] = Integer.MAX_VALUE; setOfMST[j] = false;
}
